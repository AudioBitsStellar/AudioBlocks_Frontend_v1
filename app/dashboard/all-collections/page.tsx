...
const AllCollectionsPage = () => {
  ...
  const totalPages = Math.ceil(collectionsData.length / ITEMS_PER_PAGE);

  const startIndex = (currentPage - 1) * ITEMS_PER_PAGE;
  const currentItems = collectionsData.slice(startIndex, startIndex + ITEMS_PER_PAGE);
  ...
  return (
    <div className="text-white min-h-screen">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-semibold text-white font-poppins">All Collections</h1>
      </div>
